...
$$ P(T = 11 \; | \; D\_{1} = 5) = \frac{1}{6} = 0.1667 $$
...
_We continue our series on Bayesian networks by discussing their suitability for fraud detection in complex processes: for example assessing medical non-disclosure in life insurance applications._
...
_We finish our series on Bayesian networks by discussing conditional probability, more complex models, missing data and other real-world issues in their application to insurance modelling._
...
_Readers may wish to refer to the previous article for explanations of the nodes._
