...
Lets start by creating the basic scatter plot using [Economist Data](/data/EconomistData.csv), then we can make a list of things that need to be added or changed. The basic plot loogs like this:
