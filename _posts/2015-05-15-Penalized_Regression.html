<!DOCTYPE html>
<html><head>
     <title>Computer Practical Exercise</title>
...
<hr>
<h1>Computer Practical Exercise on Penalized Regression Methods for Association Studies </h1>
<p>
...
<br> <br>
<a href="http://cran.r-project.org/web/packages/glmnet/index.html" target="mainwindow"> http://cran.r-project.org/web/packages/glmnet/index.html </a><br> <br>
...
<br> <br>
<a href="http://cran.r-project.org/web/packages/grpreg/index.html" target="mainwindow"> http://cran.r-project.org/web/packages/grpreg/index.html </a><br> <br>
...
From within R, one can obtain help on any command <tt>xxxx</tt> by typing `<tt>help(xxxx)</tt>' <br><br>
...
<a href="http://www.ebi.ac.uk/projects/BARGEN/" target="mainwindow"> http://www.ebi.ac.uk/projects/BARGEN/ </a><br> <br>
...
<a href="http://mezeylab.cb.bscb.cornell.edu/Software.aspx" target="mainwindow"> http://mezeylab.cb.bscb.cornell.edu/Software.aspx</a><br> <br>
...
<a href="Genotypes.txt" target="mainwindow">Genotypes.txt</a>

<br>

<a href="Phenotypes.txt" target="mainwindow">Phenotypes.txt</a>

<br>

<a href="SingleMarkerPvalues.txt" target="mainwindow">SingleMarkerPvalues.txt</a>

<br>

<a href="SNPNames.txt" target="mainwindow">SNPNames.txt</a>

<br>

<a href="pumadata.tfam" target="mainwindow">pumadata.tfam</a>

<br>

<a href="pumadata.tped" target="mainwindow">pumadata.tped</a>
...
(where <tt> xxxxx </tt> is replaced by the name of the appropriate folder).
...
<br> <br>
Take a look at the data files <tt> Genotypes.txt </tt> and  <tt> Phenotypes.txt  </tt> (e.g. using the <tt> more  </tt> command), and check that you understand how the data is coded.
