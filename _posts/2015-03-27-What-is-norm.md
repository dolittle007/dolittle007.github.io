...
SAD(x*1,x_2) = \left \| x_1-x_2 \right \|\_1 = \sum \left | x*{1*i}-x*{2_i} \right |
...
MAE(x*1,x_2) = \frac{1}{n} \left \| x_1-x_2 \right \|\_1 = \frac {1} {n} \sum \left | x*{1*i} - x*{2_i} \right | where n is a size of x.
...
\left \| x*1-x_2 \right \|\_2 = \sqrt{\sum_i (x*{1*i}-x*{2_i})^2}

or in its squared form, known as a Sum of Squared Difference (SSD) among Computer Vision scientists:

SSD(x*1,x_2) = \left \| x_1-x_2 \right \|\_2^2 = \sum_i (x*{1*i}-x*{2_i})^2
...
MSE(x*1,x_2) = \frac{1}{n} \left \| x_1-x_2 \right \|\_2^2 = \frac{1}{n} \sum_i (x*{1*i}-x*{2_i})^2
